...
export default class extends Controller {
  ...
  addActValues(event) {
    ...
    row.innerHTML = `
      <label for="_acts_act_value_measured" class="text-xl">Measured ACT values</label>
      <input placeholder="seconds" type="number" name="[acts][act_value_measured]" id="_acts_act_value_measured" min="1" max="1000" class="flex-1 rounded-lg border-2 border-quaternary bg-secondary-light text-secondary-dark p-2 focus:border-icon-color-dark data-hj-allow">

      <label for="_acts_act_measurement_time" class="text-xl">Time</label>
      <input type="datetime-local" name="[acts][act_measurement_time]" id="_acts_act_measurement_time" class="flex-1 rounded-lg border-2 border-quaternary bg-secondary-light text-secondary-dark p-2 focus:border-icon-color-dark data-hj-allow">
