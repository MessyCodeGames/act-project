    ...
    row.innerHTML = `
      <div class="flex lg:flex-row flex-col lg:items-center lg:gap-2 lg:my-2 lg:text-base text-sm gap-0.5 my-0.5 w-full">
        <div class="flex flex-row w-full">
          <label for="_acts_act_value_measured" class="lg:text-base text-sm flex items-center lg:mr-2 mr-1">Measured ACT value</label>
      ...
      <div class="lg:justify-center items-center flex justify-end">
        ...
        <button data-action="click->deletable#deleteActValues">
          <svg class="w-6 h-6 ml-1 fill-current lg:w-8 lg:h-8 lg:ml-2 text-icon-color-dark lg:hover:text-active-color active:scale-95" width="302.5" height="302.5" viewBox="0 0 80.036458 80.036456" version="1.1" id="svg1" xmlns="http://www.w3.org/2000/svg">
            <g id="layer1" transform="translate(-108.48175,-64.98156)">
              <path
                d="m 148.49998,64.981562 a 40.018227,40.018227 0 0 0 -40.01823,40.018228 40.018227,40.018227 0 0 0 40.01823,40.01823 40.018227,40.018227 0 0 0 40.01823,-40.01823 40.018227,40.018227 0 0 0 -40.01823,-40.018228 z m -10.44123,22.099943 c 1.93238,0.07825 3.88476,0.896044 5.40536,2.434994 l 5.09788,5.159374 5.17591,-5.114416 c 3.0779,-3.041191 7.84037,-3.169905 10.67842,-0.288354 2.83805,2.88155 2.64537,7.649629 -0.43253,10.69082 l -5.15938,5.097877 5.11442,5.17591 c 3.04119,3.0779 3.16939,7.84089 0.28784,10.67894 -2.88155,2.83805 -7.64963,2.64485 -10.69082,-0.43305 l -5.09788,-5.15937 -5.17592,5.11441 c -3.07789,3.04119 -7.84036,3.16939 -10.67841,0.28784 -2.83805,-2.88155 -2.64537,-7.64963 0.43253,-10.69082 l 5.15937,-5.09788 -5.1139,-5.175912 c -3.04119,-3.077898 -3.1699,-7.840367 -0.28835,-10.678418 1.44077,-1.419025 3.35309,-2.080198 5.28546,-2.001945 z"
